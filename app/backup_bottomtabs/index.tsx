...
import FavouritesScreen from "../BottomTabs/favourites";
...
function CustomTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  const jellyStyle = useAnimatedStyle(() => {
    return {
      paddingHorizontal: withSpring(isFavourites ? 60 : 45, {
        damping: 12,
        stiffness: 150,
        mass: 0.8,
      }),
  ...
  const jellyGlowStyle = useAnimatedStyle(() => {
    return {
      paddingHorizontal: withSpring(isFavourites ? 50 : 38, {
        damping: 12,
        stiffness: 150,
        mass: 0.8,
      }),
...
const styles = StyleSheet.create({
  ...
  jellyPill: {
    // width: "50%",
    height: "95%",
    backgroundColor: "#03AED2", // Blue background
    borderRadius: 30,
  ...
  jellyPillGlow: {
    position: "absolute",
    height: "80%",
    backgroundColor: "#03b0d225", // Translucent Blue
    borderRadius: 20,
